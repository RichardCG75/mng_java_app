...
public class Coordinador extends MiembroUNEDL {

    public Coordinador(){    super();   }
    public Coordinador(String nombre, String apellido1, String apellido2, String registro, String email) {
